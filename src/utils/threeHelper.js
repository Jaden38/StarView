...
export const createStarField = (stars, highlightedStars = [], constellation = null) => {
...
const getStarColor = (spectralType, isHighlighted = false) => {
  ...
  switch (spectralType[0]) {
    case 'O': [h, s, l] = [0.6, 1, 0.9]; break;
    case 'B': [h, s, l] = [0.55, 1, 0.8]; break;
    case 'A': [h, s, l] = [0.5, 1, 0.7]; break;
    case 'F': [h, s, l] = [0.45, 1, 0.6]; break;
    case 'G': [h, s, l] = [0.4, 1, 0.5]; break;
    case 'K': [h, s, l] = [0.35, 1, 0.4]; break;
    case 'M': [h, s, l] = [0.3, 1, 0.3]; break;
    default: [h, s, l] = [0, 0, 1];
  }
