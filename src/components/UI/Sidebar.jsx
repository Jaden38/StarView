        ...
        <div>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={(e) =>
                onFilterChange("magnitude", parseFloat(e.target.value))
              }
              className="w-full"
            />
          ...
          <p className="text-xs text-gray-400">Lower values = brighter stars</p>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={(e) =>
                onFilterChange("minTemp", parseFloat(e.target.value))
              }
              className="w-full"
            />
