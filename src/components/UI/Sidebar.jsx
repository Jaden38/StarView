...
import { Star, Thermometer, Ruler, ChevronLeft, ChevronRight, PanelLeftClose } from "lucide-react";
...
const CollapsedIcon = ({ icon: Icon, label, value, active }) => (
            ...
            <ExpandedSection icon={Star} label="Magnitude">
              <div className="space-y-4">
                <Select
                  ...
                  onValueChange={(value) => onFilterChange("magnitudeType", value)}
                >
                  ...
                  <SelectContent className="bg-zinc-900 border-zinc-800">
                    <SelectItem value="apparent" className="text-zinc-300">Apparent</SelectItem>
                    <SelectItem value="absolute" className="text-zinc-300">Absolute</SelectItem>
                  </SelectContent>
                </Select>
                ...
                <div className="space-y-2">
                  <Slider
                    ...
                    onValueChange={([value]) => onFilterChange("magnitude", value)}
                    className="transition-all hover:opacity-100"
                  />
                  <div className="flex items-center justify-between">
                    <Badge variant="outline" className="bg-zinc-900/80 text-zinc-400 border-zinc-800/50 transition-colors hover:border-zinc-700">
            ...
            <ExpandedSection icon={Thermometer} label="Temperature">
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <Badge 
                    variant="outline" 
                    className={`${getTemperatureColor(filters.minTemp)} border-0`}
                  >
